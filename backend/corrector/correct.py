...
class Correcter:
    def __init__(self, lm):
        self.lm = lm  # 语言模型
        self.pb_dic = self.load_dic('C:\\Users\\Administrator\\Desktop\\sys\\server\\corrector\\data\\same_pinyin.txt')  # 候选字典
...
def correct(context):
    corpus = open('C:\\Users\\Administrator\\Desktop\\sys\\server\\corrector\\data\\tech_corpus.txt', encoding='utf8').readlines()
